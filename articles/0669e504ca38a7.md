...
Cloudflare で IaC をやるときに Terraform で HCL([Hashicorp Configuration Language](https://developer.hashicorp.com/terraform/language/syntax/configuration)) かー。という気分になっていたところに CDKTF に出会い半年程使って体験が良かったので紹介します。
